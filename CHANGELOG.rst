...
- Add an opt-in FP8 Vision Encoder recipe for Nemotron 3 Nano Omni. It quantizes C-RADIO and vision-projector Linears while keeping the language model, audio branch, KV cache, patch generator, and vision-attention operands in high precision.
